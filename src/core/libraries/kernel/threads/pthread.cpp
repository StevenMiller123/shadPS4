...
s32 PS4_SYSV_ABI posix_pthread_get_user_context_np() {
    return ORBIS_OK;
}

s32 PS4_SYSV_ABI posix_pthread_suspend_user_context_np() {
    return ORBIS_OK;
}

s32 PS4_SYSV_ABI posix_pthread_resume_user_context_np() {
    return ORBIS_OK;
}
