    ...
    if ((mod.flags & OrbisSysmoduleModuleInternalFlags::IsGame) != 0) {
        ...
        constexpr auto ModulesToLoad = std::to_array<Core::SysModules>(
            {{"libSceNgs2.sprx", &Libraries::Ngs2::RegisterLib},
             ...
             {"libSceRegMgr.sprx", nullptr},
             {"libSceIpmi.sprx", nullptr},
             {"libScePsm.sprx", nullptr},
             {"libSceMetadataReaderWriter.sprx", nullptr},
             {"libSceAbstractStorage.sprx", nullptr},
             {"libSceAbstractLocal.sprx", nullptr},
             {"libSceAsyncStorageInternal.sprx", nullptr},
